...
utilizando fórmula: V = 3.14159 * R * R * A, em que as
variáveis: V, R e A representam respectivamente o volume, o raio e a altura.
Vamos declarar as variáveis V, R e A como double e definir um valor
...
public class Exercicio5 {
    public static void main(String[]args){
        ...
        System.out.print("O volume da lata de óleo é de " + V + " m³");
    }
}
